...
{
    public class SettingProgramManagerBase : CommonUIComponentBase
    {
        ...
        {
            parameters.Add("PGM_ID", ProgramID.ToStringTrim());
            parameters.Add("PGM_NAME", ProgramName.ToStringTrim());
        }
        ...
        private async Task<DataTable?> DBSearch()
        {
            ...
            var datatable = await QueryService.ExecuteDatatableAsync("SP_SETTING_PROGRAM_SELECT", new Dictionary<string, object?>()
                {
                    { "PGM_ID", ProgramID.ToStringTrim() },
                    { "PGM_NAME", ProgramName.ToStringTrim() },
                });
        ...
        private async Task DBSave(DataTable datatable)
        {
            ...
            await QueryService.ExecuteNonQuery("SP_SETTING_PROGRAM_SAVE", datatable, new Dictionary<string, object?>()
            {
                { "REG_ID", USER_ID },
            });
        }
        ...
        private async Task DBDelete(DataTable datatable)
        {
            ...
            await QueryService.ExecuteNonQuery("SP_SETTING_PROGRAM_DELETE", datatable, new Dictionary<string, object?>()
            {
                { "REG_ID", USER_ID },
            });
        }
