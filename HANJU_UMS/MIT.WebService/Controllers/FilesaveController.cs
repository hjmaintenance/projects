...
[ApiController]
public class FilesaveController : CommonControllerBase {

  IHostEnvironment env;
  ILogger<FilesaveController> logger;
  public FilesaveController(MSSQLDatabaseService mssqlDatabaseService, IHttpContextAccessor httpContextAccessor, IHostEnvironment _env, ILogger<FilesaveController> _logger)
