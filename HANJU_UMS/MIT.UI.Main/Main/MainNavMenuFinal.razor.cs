...
namespace MIT.UI.Main.Main {
  public class MainNavMenuFinalBase : CommonUIComponentBase {
    ...
    protected void OnNodeClick(TreeViewNodeClickExEventArgs e) {
        ...
        Console.WriteLine("adsfadfadfadfadfafadfasd");
    ...
    public void OnSizeSwitch() {

      var isSwitch = true;
      if (StateCssClass == "collapse") {
        StateCssClass = "expand";
        isSwitch = false;
      }
      else {
        StateCssClass = "collapse";
      ...
      ToggleSidebarEvent?.Invoke(this, isSwitch);
