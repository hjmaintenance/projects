...
public class MitCombo : DxComboBox<CommCode, string> {
  ...
  public async Task SetData() {
    ...
    if (!IsAll && comm_dt != null && comm_dt.Count > 0) {
      ...
      //CmId = comm_dt.FirstOrDefault<CommCode>().Name;
      //CmName = comm_dt.FirstOrDefault<CommCode>().Value; 

      //SelectedItem = comm_dt.FirstOrDefault<CommCode>();
      //this.Text = comm_dt[0].Value;
      //StateHasChanged();
      //this.InvokeAsync(StateHasChanged);


      var nameVal = comm_dt.FirstOrDefault<CommCode>().Name;
  ...
  //public CommCode SelectedItem { get; set; }
