...
{
    public class CommonGrid2Base : CommonUIComponentBase
    {
        /// <summary>
    ...
    [Parameter]
    public Dictionary<string, string>? DataCellCss { get; set; } = new Dictionary<string, string>();
    [Parameter]
    public Dictionary<string, string>? DataRowCss { get; set; } = new Dictionary<string, string>();
