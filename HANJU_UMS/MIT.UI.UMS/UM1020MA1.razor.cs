...
* 작성일자 : 25-02-21
* 최종수정 : 25-02-21
* 프로시저 : P_HMI_USE_COM_COMTOTAL_M0_SELECT
*/     
...
{
    public class UM1020MA1Base : CommonUIComponentBase
    {
        ...
        private void InitControls()
        {
            if (Grd1 == null || Grd1.Grid == null)
                return;
            Grd1.SetCellStyle("COM_NAME","합계,합 계");
        ...
        private async Task<DataTable?> DBSearch()
        {
            ...
            var datatable = await QueryService.ExecuteDatatableAsync("P_HMI_USE_COM_COMTOTAL_SELECT_01", new Dictionary<string, object?>()
                {
