...
{
    public class US2020QA1Base : CommonUIComponentBase
    {
        ...
        private async Task<DataTable?> DBSearch()
        {
            ...
            var datatable = await QueryService.ExecuteDatatableAsync("P_HMI_USE_MONTHELCDAY_SELECT01", new Dictionary<string, object?>()
                {
