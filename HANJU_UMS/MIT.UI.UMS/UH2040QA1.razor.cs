...
{
    public class UH2040QA1Base : CommonUIComponentBase
    {
        ...
        {
            //parameters.Add("DATE", YYMM?.EditValue);
        ...
        private async Task<DataTable?> DBSearch()
        {
            ...
            string procedureName = string.IsNullOrWhiteSpace(COM_ID) ? "P_HMI_ELEC_COM_SERV_RST" : "P_HMI_ELEC_COM_SERV_COM_RST"; // 업체 선택 안한경우 : 업체 선택한 경우
