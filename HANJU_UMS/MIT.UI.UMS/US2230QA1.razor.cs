...
* 최종수정 : 25-02-07
* 화면명 : 용수 월별 사용량 현황
* 프로시저 : P_HMI_USE_YEARWATMONTH_SELECT01
*/
...
{
    public class US2230QA1Base : CommonUIComponentBase
    {
        ...
        private async Task<DataTable?> DBSearch()
        {
            ...
            var datatable = await QueryService.ExecuteDatatableAsync("P_HMI_USE_YEARWATMONTH_SELECT01", new Dictionary<string, object?>()
                {
                    {"YYYY", YYYY?.EditValue},
