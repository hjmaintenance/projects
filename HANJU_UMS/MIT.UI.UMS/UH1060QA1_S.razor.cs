...
{
    public class UH1060QA1_SBase : CommonUIComponentBase, IDisposable
    {
        ...
        private void InitControls()
        {
            ...
            {
                Grd1.SetCellStyle("COM_MC", "순수계");
                Grd1.SetCellStyle("COM_MC", "제염 응축수", "row3");
            }

            if (!(Grd2 == null || Grd2.Grid == null)) {
                Grd2.SetCellStyle("COM_MC", "입주사계", "row2");
                Grd2.SetCellStyle("COM_MC", "여과수 계","row3");
                Grd2.SetCellStyle("COM_MC", "제염소계");
            }
        }
        ...
        private async Task Search()
        {
            ...
            try
            {
                ...
                Grd1.DataSource = await DBSearchDW();

                await Grd1.PostEditorAsync();

                Grd2.DataSource = await DBSearchFW();
