...
{
    public class US2010QA1Base : CommonUIComponentBase
    {
        ...
        private async Task<DataTable?> DBSearch()
        {
            ...
            var datatable = await QueryService.ExecuteDatatableAsync("P_HMI_USE_DAYELCTIME_SELECT01", new Dictionary<string, object?>()
                {
                    {"DATE", DATE?.EditValue },
