...
{
    public class DCP00401Base : CommonUIComponentBase
    {
        protected CommonDateEdit? Dte_FromDate { get; set; }
        protected CommonDateEdit? Dte_ToDate { get; set; }

        protected CommonTextBox? Txt_LineCd { get; set; }
        protected CommonTextBox? Txt_ProcCd { get; set; }
        ...
        protected void Grd1_OnInputSearchParameter(Dictionary<string, object?> parameters)
        {
            ...
            parameters.Add("LINE_CD", Txt_LineCd?.EditValue);
            parameters.Add("PROC_CD", Txt_ProcCd?.EditValue);
        }
