...
const aaaaaaaaaaa = async()=>{
  ...
  //const ggggg = await improvementRequestService.searchRequests({ customerId: loginUser.value.user_uid });
  ...
  if (loginUser.value && loginUser.value.user_uid) {
    try {
      ...
      //console.log('requests', requests, requests.value);
...
<Button @click="aaaaaaaaaaa">aaaa</Button>
