...
const _service = serviceWrapper('CompanyService', _serviceMethods);
...
export const CompanyService = {
  ...
  delete: (company, loading) => callWithLoading(loading, () => _service.delete(company, { serviceName: 'CompanyService' })),
